...
export default function SpeakingPage() {
  ...
  async function submitAudio() {
    ...
    try {
      ...
      formData.append("taskPrompt", task.prompt);
      formData.append("taskNumber", String(task.task_number));
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-purple-700 text-white py-6 px-6 shadow">
        ...
        <p className="text-purple-200 mt-1">
          AI-powered speaking evaluation with real-time transcription
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="flex gap-3 mb-6 flex-wrap">
          <a href="/" className="px-4 py-2 bg-white border rounded-full text-gray-600 text-sm hover:border-blue-400">
            ✍️ Writing
          </a>
          <a href="/reading" className="px-4 py-2 bg-white border rounded-full text-gray-600 text-sm hover:border-green-400">
            📖 Reading
          </a>
        ...
        {task && phase === "idle" && (
          <div className="bg-white rounded-xl shadow p-6 mb-6 border-l-4 border-purple-600">
            ...
            <button
              ...
              className="w-full bg-purple-600 hover:bg-purple-700 text-white
                         font-semibold py-3 rounded-xl shadow transition"
            >
              ▶️ Start Preparation Time
            </button>
          </div>
        )}
          ...
          <div className="bg-white rounded-xl shadow p-8 mb-6 text-center">
            ...
            {task && (
              <div className="bg-gray-50 rounded-lg p-4 mt-4 text-left">
                <p className="font-semibold text-gray-700 mb-1">Remember:</p>
          ...
          <div className="bg-white rounded-xl shadow p-8 mb-6 text-center">
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white
                         font-semibold py-3 px-8 rounded-xl shadow transition"
            >
        ...
        {phase === "done" && evaluation && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <ul className="space-y-2">
                {evaluation.strengths.map((s, i) => (
                  <li key={i} className="bg-green-50 text-green-800 rounded-lg p-3 text-sm">
                    {s}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <ul className="space-y-2">
                {evaluation.areas_to_improve.map((s, i) => (
                  <li key={i} className="bg-orange-50 text-orange-800 rounded-lg p-3 text-sm">
                    {s}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <p className="bg-purple-50 rounded-lg p-4 text-purple-800 text-sm italic leading-relaxed">
                {evaluation.sample_improved_response}
              </p>
            </div>
